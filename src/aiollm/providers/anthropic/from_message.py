...
class FromMessage:
    ...
    def from_tool_message(message: ToolMessage) -> MessageParam:
        ...
        return {"role": "user", "content": [{"type": "tool_result", "tool_use_id": message.id, "content": content}]}
    ...
    def from_system_message(message: SystemMessage) -> list[TextBlockParam]:
        ...
        return [FromMessage.from_system_content(content) for content in message.content]
